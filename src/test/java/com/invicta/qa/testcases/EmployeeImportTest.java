...
/*
@Test
public void EmployeeImportButton() throws InterruptedException 
{
	 ...
	 testCase = extent.createTest("Step1:- EMPLOYEE-IMPORT-BUTTON UI PROPERTIES");
		try {
			...
			testCase = extent.createTest("1-EMPLOYEE-IMPORT-BUTTON-VISIBLE");
			try {
...
//Employee Import Button FONT-COLOR
		...
		try {	
			String ActualTitleFontColor = EmployeeImportPage.ImportButton.getCssValue("color");
...
//Employee Import Button FONTSIZE
	...
	try {
				String ActualTitleFontsSize = EmployeeImportPage.ImportButton.getCssValue("font-size");
				System.out.println("Font Size: " + ActualTitleFontsSize);
				String ExpectedTitleFontsSize = "14px";
				testCase = extent.createTest("3.EMPLOYEE-IMPORT-BUTTON-FONT-SIZE");
			try{
...
//Employee Import Button Font-Family 
		...
		try {
			String ActualElementfamily = EmployeeImportPage.ImportButton.getCssValue("font-family");
			System.out.println("FONT-FAMILY: "+ActualElementfamily);
			String ExpectedElementFamily = "Roboto, sans-serif";
			testCase = extent.createTest("4.EMPLOYEE-IMPORT-BUTTON-FONT-FAMILY");
		try {
...
//Employee Import Button Spelling	
	...
	try {
			  String AcctualTitleText = EmployeeImportPage.ImportButton.getText();
...
//Employee Import Button Position
		...
		try {
				Point ActulalLocation = EmployeeImportPage.ImportButton.getLocation();        
				...
				Point ExpectedLocation = new Point(987, 93);
...
//Employee Import Button Padding 
		...
		try { 
					String Actualpadding = EmployeeImportPage.ImportButton.getCssValue("padding");
					System.out.println("PADDING: "+Actualpadding);
					String Expectedpadding = "0px";
					testCase = extent.createTest("7.EMPLOYEE-IMPORT-BUTTON-TEXT-PADDING");
				try {
...
try {
		String Actualshadow = EmployeeImportPage.ImportButton.getCssValue("box-shadow");
...
try {
		String Actualbackground = EmployeeImportPage.ImportButton.getCssValue("color");
		System.out.println("BACKGROUND COLOR:" + Actualbackground);
		String Expectedbackground= "rgba(0, 0, 0, 0.85)";
...
//Employee Import Button BORDER COLOR
		try {		 
				String actualbordercolor = EmployeeImportPage.ImportButton.getCssValue("border-color");
				System.out.println(" border-color:" + actualbordercolor);
				String Expectedbordercolor = "rgba(0, 0, 0, 0.85)";
				testCase = extent.createTest("10.EMPLOYEE-IMPORT-BUTTON-BORDER-COLOR");
				try {
...
//Employee Import Button CURSER POINT	 
		...
		try {	 
				String ActualCursor = EmployeeImportPage.ImportButton.getCssValue("cursor");
				System.out.println("cursor :" + ActualCursor);
				String Expectedcursor = "auto";
				testCase = extent.createTest("11.EMPLOYEE-IMPORT-BUTTON-CURSOR");
				try {
...
//Employee Import Button OPACITY 
		...
		try {
				String Actualopacity = EmployeeImportPage.ImportButton.getCssValue("opacity");
				System.out.println("OPACITY :" + Actualopacity);
				
				String Expectedopacity = "1";
				testCase = extent.createTest("12.EMPLOYEE-IMPORT-BUTTON-OPACITY");
				try {
...
//Employee Import Button HEIGHT
		...
		try {	 
				String ActualHeight =EmployeeImportPage.ImportButton.getCssValue("height");
				System.out.println("Height :" + ActualHeight);
				String ExpectedHeight = "32px";
				testCase = extent.createTest("13.EMPLOYEE-IMPORT-BUTTON-HEIGHT");
				try {
...
//Employee Import Button Width
		...
		try {	 
				String Actualwidth =EmployeeImportPage.ImportButton.getCssValue("width");
				System.out.println("width :" + Actualwidth);
			
				String Expectedwidth = "95.5781px";
				testCase = extent.createTest("14.EMPLOYEE-IMPORT-BUTTON-WIDTH");
				try {
...
//Employee Import Button Font-weight
		...
		try {
				String Actualweight = EmployeeImportPage.ImportButton.getCssValue("font-weight");
				System.out.println("16.Font-weight :" + Actualweight);
				String Expectedweight = "400";
				testCase = extent.createTest("15.EMPLOYEE-IMPORT-BUTTON-FONT-WEIGHT");
				try {
...
/*
@Test
public void EmployeeExportButton() throws InterruptedException 
{
	 testCase = extent.createTest("Step2:- EMPLOYEE-EXPORT-BUTTON UI PROPERTIES");
		try {
			...
			testCase = extent.createTest("1-EMPLOYEE-EXPORT-BUTTON-VISIBLE");
			try {
			//	ExpectedTextVisible=false;
				Assert.assertEquals(ActualTextVisible, ExpectedTextVisible);
				testCase.log(Status.INFO, "Actual Visible :- " + ActualTextVisible);
...
//Employee Export Button FONT-COLOR
		...
		try {	
			String ActualTitleFontColor = EmployeeImportPage.ExportButton.getCssValue("color");
			System.out.println("Font color of button: " + ActualTitleFontColor);
...
//Employee Export Button FONTSIZE
	...
	try {
				String ActualTitleFontsSize = EmployeeImportPage.ExportButton.getCssValue("font-size");
				System.out.println("Font Size: " + ActualTitleFontsSize);
				String ExpectedTitleFontsSize = "14px";
				testCase = extent.createTest("3.EMPLOYEE-EXPORT-BUTTON-FONT-SIZE");
			try{
			  AssertJUnit.assertEquals(ActualTitleFontsSize, ExpectedTitleFontsSize);
			  testCase.log(Status.INFO, "ActualfontSize :-" + ActualTitleFontsSize);
			  testCase.log(Status.INFO, "ExpectedfontSize:-" + ExpectedTitleFontsSize);
...
//Employee Export Button Font-Family 
		...
		try {
			String ActualElementfamily = EmployeeImportPage.ExportButton.getCssValue("font-family");
			System.out.println("FONT-FAMILY: "+ActualElementfamily);
			String ExpectedElementFamily = "Roboto, sans-serif";
			testCase = extent.createTest("4.EMPLOYEE-EXPORT-BUTTON-FONT-FAMILY");
		try {
			  Assert.assertEquals(ActualElementfamily, ExpectedElementFamily);
			  testCase.log(Status.INFO, "ActualText :- " + ActualElementfamily);
			  testCase.log(Status.INFO, "ExpectedText :- " + ExpectedElementFamily);
...
//Employee Export Button Spelling	
	...
	try {
			  String AcctualTitleText = EmployeeImportPage.ExportButton.getText();
...
//Employee Export Button Position
		...
		try {
				Point ActulalLocation = EmployeeImportPage.ExportButton.getLocation();        
				int actual_x = ActulalLocation.getX();
				int actual_y = ActulalLocation.getY();
				System.out.println("X axis: " + actual_x);
				System.out.println("Y axis: " + actual_y);
				Point ExpectedLocation = new Point(1106, 93);
...
//Employee Export Button Padding 
		...
		try { 
					String Actualpadding = EmployeeImportPage.ExportButton.getCssValue("padding");
					System.out.println("PADDING: "+Actualpadding);
					String Expectedpadding = "4px 16px";
					testCase = extent.createTest("7.EMPLOYEE-EXPORT-BUTTON-TEXT-PADDING");
				try {
					  Assert.assertEquals(Actualpadding, Expectedpadding);
					  testCase.log(Status.INFO, "Actual padding :- " + Actualpadding);
					  testCase.log(Status.INFO, "Expected padding :- " + Expectedpadding);
...
try {
		String Actualshadow = EmployeeImportPage.ExportButton.getCssValue("box-shadow");
		System.out.println("Text Shadow :" + Actualshadow);
...
try {
		String Actualbackground = EmployeeImportPage.ExportButton.getCssValue("color");
		System.out.println("BACKGROUND COLOR:" + Actualbackground);
...
//Employee Export Button BORDER COLOR
		try {		 
				String actualbordercolor = EmployeeImportPage.ExportButton.getCssValue("border-color");
				System.out.println(" border-color:" + actualbordercolor);
...
//Employee Export Button CURSER POINT	 
		...
		try {	 
				String ActualCursor = EmployeeImportPage.ExportButton.getCssValue("cursor");
				System.out.println("cursor :" + ActualCursor);
...
//Employee Export Button OPACITY 
		...
		try {
				String Actualopacity = EmployeeImportPage.ExportButton.getCssValue("opacity");
				System.out.println("OPACITY :" + Actualopacity);
...
//Employee Export Button HEIGHT
		...
		try {	 
				String ActualHeight =EmployeeImportPage.ExportButton.getCssValue("height");
				System.out.println("Height :" + ActualHeight);
				String ExpectedHeight = "32px";
...
//Employee Export Button Width
		...
		try {	 
				String Actualwidth =EmployeeImportPage.ExportButton.getCssValue("width");
				System.out.println("width :" + Actualwidth);
...
//Employee Export Button Font-weight
		...
		try {
				String Actualweight = EmployeeImportPage.ExportButton.getCssValue("font-weight");
				System.out.println("16.Font-weight :" + Actualweight);
				String Expectedweight = "400";
...
// Import CSV
public static void UploadCSV() throws InterruptedException, FileNotFoundException, AWTException 
{
	Thread.sleep(2000);
